...
def get_files(hps):
    ...
    valid_file = os.path.join(hps.data_dir, "test.label.jsonl")
    ...
    val_w2s_path = os.path.join(hps.cache_dir, "test.w2s.tfidf.jsonl")
...
def main():
    ...
    # CAN use HDSG
        ...
        raise NotImplementedError("Model Type has not been i"
                                  "mplemented")
