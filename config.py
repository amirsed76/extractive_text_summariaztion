...
def pars_args():
    ...
    parser.add_argument('--cache_dir', type=str, default=f'{root}\\cache\\CNNDM',
    ...
    parser.add_argument('--log_root', type=str, default=f'{root}\\results\\log\\', help='Root directory for all logging.')
